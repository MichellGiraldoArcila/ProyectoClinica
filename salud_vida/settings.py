"""
Configuración del sistema HCE - IPS Salud y Vida.
Resolución 866 de 2021 - Ministerio de Salud de Colombia.
"""
...
WSGI_APPLICATION = 'salud_vida.wsgi.application'
...
if DB_ENGINE == 'mysql':
    DATABASES = {
        'default': {
            ...
            'NAME': config('DB_NAME', default='salud_vida_hce'),
